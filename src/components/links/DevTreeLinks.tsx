...
type Props = {
  link: DevTreeLink;
  handleUrlChange: (name: string, url: string) => void;
  handleEnableLink: (name: string) => void;
};

export const DevTreeLinks = ({
  link,
  handleUrlChange,
  handleEnableLink,
}: Props) => {
  return (
    <div className="bg-white shadow-sm p-5 flex items-center gap-4">
      <div
      ...
      <input
        type="text"
        className="flex-1 border border-gray rounded-lg"
        value={link.url}
